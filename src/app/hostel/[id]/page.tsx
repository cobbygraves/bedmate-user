        ...
        <div className="lg:w-2/3 space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              This is a detailed description of the hostel, providing insights into the amenities available for guests. The
              hostel features comfortable dormitory-style rooms, as well as private accommodations. Guests can enjoy a fully
              equipped kitchen, a cozy common room for socializing, and complimentary Wi-Fi throughout the property. Located
              in a vibrant neighborhood, the hostel is within walking distance of local attractions, cafes, and public
              transportation, making it an ideal base for exploring the city. Our friendly staff are available 24/7 to assist
              with any inquiries and to ensure your stay is as enjoyable as possible.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="border-b pb-2">
                <p className="text-gray-800">
                  <strong>Emily Johnson:</strong> Had a wonderful time, highly recommend!
                </p>
              </div>
            </div>
          </div>
